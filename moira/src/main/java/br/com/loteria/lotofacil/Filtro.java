...
public class Filtro {
	...
	public List<Jogo> filtrar() throws FileNotFoundException, IOException {
		...
		pares(Arrays.asList(6,7,8)); // 5a9; // {3=3, 4=21, 5=117, 6=339, 7=516, 8=429, 9=182,  10=41, 11=5} 
		primos(Arrays.asList(4,5,6,7)); // 4a7 {2=5, 3=76, 4=278, 5=520, 6=451, 7=257, 8=62, 9=4} 
		sequenciaDeFibonacci(Arrays.asList(4,5,6));// 2a6 {1=8, 2=94, 3=351, 4=610, 5=479, 6=200, 7=19}
		...
		QtdFiltros(Arrays.asList(2,4)); //1a4// {1=169; 2=1190; 3=366; 4=53; 5=1}
		...
		incluir(Arrays.asList(2)); // 1[4];2[4];3[3,4];4[4];5[4];6[4];7[4];8[4];9[4];10[3,4];11[4];12[3,4];13[4];14[3,4];15[4];16[4];17[3,4];18[4];19[3,4];20[4];21[4];22[3,4];23[4];24[4];25[4];
		//retirar(Arrays.asList(4)); // 1 [7,8]; 2[7,8];3[6,7,8];4[8];5[8];6[7,8];7[6,7,8];8[7];9[7];10[8,9];11[7,8,9,10];12[7,8,9];13[8,9];14[7,8,9];15[6,7,8];16[7,8];17[6,7,8];18[7,8,9];19[7,8];20[7,8];21[7,8];22[6,7];23[7,8];24[7,8,9];25[7,8,9];
		//naoIniciarCom(Arrays.asList(2,3,4));
