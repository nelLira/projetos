...
public class Filtro {
	...
	public List<Jogo> filtrar() throws FileNotFoundException, IOException {
		...
		sequenciaDeFibonacci(Arrays.asList(2,4,5));// 2a6 {1=8, 2=94, 3=351, 4=610, 5=479, 6=200, 7=19}
		quadrado(Arrays.asList(9,11)); // 8a11 {6=2, 7=52,8=199, 9=450, 10=483, 11=261, 12=88,13=6} 
		multiplosDeTres(Arrays.asList(4,5,7)); // 3a7 {1=1, 2=33, 3=193, 4=430, 5=541,  6=317,7=111,8=14}
		dezMais(Arrays.asList(4,6,7)); // 4a8 {2=2, 3=24, 4=140, 5=387, 6=567, 7=415, 8=165, 9=24, 10=3} 
