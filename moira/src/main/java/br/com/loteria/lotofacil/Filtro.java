...
public class Filtro {
	...
	public List<Jogo> filtrar() throws FileNotFoundException, IOException {
		...
		sequenciaDeFibonacci(Arrays.asList(2,3,5,6));// 2a6 {1=8, 2=94, 3=351, 4=610, 5=479, 6=200, 7=19}
		...
		dezMais(Arrays.asList(4,5,7,8)); // 4a8 {2=2, 3=24, 4=140, 5=387, 6=567, 7=415, 8=165, 9=24, 10=3} 
