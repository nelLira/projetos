...
public class Filtro {
	...
	public List<Jogo> filtrar() throws FileNotFoundException, IOException {
		...
		pares(Arrays.asList(5,6,8,9)); // 5a9; // {3=3, 4=21, 5=117, 6=339, 7=516, 8=429, 9=182,  10=41, 11=5} 
		...
		maiorSequenciaUmEmUm(Arrays.asList(3,4,5,8,9,10)); //3a10 {2=8, 3=231, 4=572, 5=499, 6=287, 7=123,  8=54, 9=20, 10=19, 11=3, 12=2, 13=0, 14=1 }
		...
		incluir(Arrays.asList(15,2)); // 1[4];2[4];3[3,4];4[4];5[4];6[4];7[4];8[4];9[4];10[3,4];11[4];12[3,4];13[4];14[3,4];15[4];16[4];17[3,4];18[4];19[3,4];20[4];21[4];22[3,4];23[4];24[4];25[4];
