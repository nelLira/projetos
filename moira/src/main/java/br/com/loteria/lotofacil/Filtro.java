...
public class Filtro {
	...
	public List<Jogo> filtrar() throws FileNotFoundException, IOException {
		...
		sequenciaDeFibonacci(Arrays.asList(4,5));// 2a6 {1=8, 2=94, 3=351, 4=610, 5=479, 6=200, 7=19}
		...
		QtdFiltros(Arrays.asList(2)); //1a4// {1=169; 2=1190; 3=366; 4=53; 5=1}
		maiorSequenciaDoisEmDois(Arrays.asList(2,3,5)); //1a5 {1=29, 2=847, 3=686, 4=205, 5=41, 6=9, 7=2}
		maiorSequenciaUmEmUm(Arrays.asList(3,4,5,6,8,10)); //3a10 {2=8, 3=231, 4=572, 5=499, 6=287, 7=123,  8=54, 9=20, 10=19, 11=3, 12=2, 13=0, 14=1 }
