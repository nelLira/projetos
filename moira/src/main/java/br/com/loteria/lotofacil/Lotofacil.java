...
public class Lotofacil {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		//estatisticasUltimosSorteios(50, true);
		 ...
		 jogos.add(new Jogo(Arrays.asList(2, 4, 5, 6, 7, 8, 11, 12, 14, 15, 17, 19, 20, 21, 25)));
		 jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 7, 9, 13, 14, 15, 17, 18, 20, 22, 23)));
		 jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 7, 9, 11, 12, 13, 14, 15, 17, 20, 22, 23)));
		 jogos.add(new Jogo(Arrays.asList(1, 2, 4, 6, 7, 9, 10, 13, 14, 16, 17, 19, 21, 22, 24)));
		 jogos.add(new Jogo(Arrays.asList(1, 2, 6, 8, 10, 11, 12, 13, 14, 16, 17, 19, 21, 22, 24)));
		 jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 6, 7, 11, 14, 15, 17, 18, 19, 22, 24, 25)));
		 jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 5, 7, 8, 9, 11, 14, 15, 17, 21, 22, 24)));
		 jogos.add(new Jogo(Arrays.asList(1, 3, 4, 6, 7, 11, 12, 13, 14, 15, 17, 18, 22, 23, 25)));
		 jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 5, 6, 8, 11, 12, 14, 16, 17, 22, 24, 25)));
