...
public class Lotofacil {
	...
	/*
		...
		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 5, 7, 8, 9, 10, 11, 13, 18, 20, 21, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 4, 5, 6, 7, 8, 10, 11, 12, 17, 18, 19, 20, 21, 23)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 8, 9, 10, 12, 13, 17, 18, 20, 21, 23)));
		...
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 5, 7, 8, 9, 10, 14, 17, 18, 20, 21, 23)));
