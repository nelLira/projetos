...
public class Lotofacil {
	...
	//	estatisticasUltimosSorteios(50, true);
		...
		jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 7, 10, 13, 16, 18, 19, 21, 23, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 4, 6, 7, 9, 12, 14, 16, 19, 20, 21, 22, 23, 24)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 4, 5, 6, 7, 10, 14, 16, 18, 19, 21, 22, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 6, 9, 11, 12, 13, 15, 16, 17, 18, 20, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 6, 7, 8, 12, 14, 16, 19, 21, 22, 23, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 5, 7, 9, 10, 12, 16, 17, 18, 20, 21, 22, 23, 24)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 6, 9, 12, 14, 16, 17, 18, 19, 21, 22, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 6, 7, 10, 12, 13, 15, 16, 17, 20, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 7, 9, 10, 12, 15, 16, 17, 18, 20, 21, 23, 25)));
