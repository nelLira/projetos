...
public class Lotofacil {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		jogos.add(new Jogo(Arrays.asList(1, 4, 5, 8, 11, 12, 15, 17, 18, 20, 21, 22, 23, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 6, 8, 10, 11, 12, 14, 19, 20, 21, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 6, 8, 12, 14, 17, 18, 20, 21, 22, 23, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 4, 6, 7, 8, 10, 12, 13, 15, 16, 17, 22, 23, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 6, 9, 10, 11, 13, 15, 16, 18, 19, 21, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 6, 10, 11, 12, 15, 16, 17, 18, 19, 21, 23, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 4, 6, 7, 9, 10, 11, 13, 15, 18, 20, 22, 24, 25)));
