...
//estatisticasUltimosSorteios(50, true);
			...
			jogos.add(new Jogo(Arrays.asList(1, 3, 4, 6, 8, 9, 11, 12, 13, 16, 17, 19, 20, 23, 24)));
			jogos.add(new Jogo(Arrays.asList(3, 4, 6, 7, 8, 9, 11, 12, 15, 18, 19, 20, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 9, 11, 12, 14, 15, 16, 18, 20, 21, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 4, 8, 11, 12, 13, 15, 17, 18, 20, 21, 22, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 6, 8, 10, 11, 12, 13, 15, 18, 19, 20, 22, 23, 24)));
			jogos.add(new Jogo(Arrays.asList(1, 3, 4, 5, 6, 7, 9, 12, 15, 18, 19, 20, 22, 23, 24)));
			jogos.add(new Jogo(Arrays.asList(1, 4, 7, 8, 9, 12, 13, 16, 18, 19, 20, 21, 22, 23, 24)));
			jogos.add(new Jogo(Arrays.asList(1, 5, 6, 7, 8, 9, 11, 12, 14, 17, 19, 20, 21, 23, 24)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 6, 8, 11, 12, 13, 15, 17, 18, 19, 20, 23, 24, 25)));
