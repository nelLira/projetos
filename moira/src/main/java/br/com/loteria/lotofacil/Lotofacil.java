...
jogos.add(new Jogo(Arrays.asList(1, 2, 5, 7, 8, 12, 14, 15, 17, 18, 20, 22, 23, 24, 25)));
jogos.add(new Jogo(Arrays.asList(1, 5, 6, 7, 8, 10, 12, 15, 17, 18, 19, 22, 23, 24, 25)));
jogos.add(new Jogo(Arrays.asList(3, 7, 8, 9, 11, 12, 14, 15, 16, 17, 20, 22, 23, 24, 25)));
jogos.add(new Jogo(Arrays.asList(1, 4, 5, 6, 7, 9, 10, 11, 12, 17, 18, 19, 21, 23, 25)));
jogos.add(new Jogo(Arrays.asList(1, 2, 6, 8, 9, 12, 14, 15, 17, 19, 20, 21, 23, 24, 25)));
