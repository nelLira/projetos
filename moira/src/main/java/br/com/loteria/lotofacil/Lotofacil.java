...
public class Lotofacil {
	...
	jogos.add(new Jogo(Arrays.asList(1, 2, 5, 6, 7, 10, 11, 13, 14, 15, 16, 18, 19, 22, 25)));
	jogos.add(new Jogo(Arrays.asList(1, 2, 7, 9, 10, 11, 13, 15, 16, 18, 20, 22, 23, 24, 25)));
	jogos.add(new Jogo(Arrays.asList(1, 3, 4, 7, 8, 9, 10, 11, 12, 16, 17, 20, 22, 23, 24)));
	jogos.add(new Jogo(Arrays.asList(1, 2, 3, 6, 8, 9, 10, 13, 15, 17, 19, 20, 22, 23, 25)));
	jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 5, 8, 11, 12, 15, 17, 18, 20, 22, 23, 24)));
	jogos.add(new Jogo(Arrays.asList(1, 2, 5, 9, 11, 13, 14, 15, 18, 19, 20, 22, 23, 24, 25)));
	jogos.add(new Jogo(Arrays.asList(1, 2, 5, 7, 9, 14, 15, 16, 17, 18, 19, 22, 23, 24, 25)));
	jogos.add(new Jogo(Arrays.asList(3, 5, 9, 10, 12, 13, 14, 15, 16, 17, 19, 22, 23, 24, 25)));
	jogos.add(new Jogo(Arrays.asList(3, 4, 6, 7, 8, 11, 12, 15, 16, 18, 19, 20, 21, 23, 25)));
	jogos.add(new Jogo(Arrays.asList(1, 2, 3, 9, 10, 11, 14, 16, 17, 18, 19, 21, 22, 24, 25)));
	jogos.add(new Jogo(Arrays.asList(2, 3, 4, 6, 10, 11, 13, 14, 15, 17, 19, 21, 22, 24, 25)));
	jogos.add(new Jogo(Arrays.asList(1, 4, 6, 7, 8, 11, 14, 15, 16, 17, 19, 21, 22, 23, 25)));
	jogos.add(new Jogo(Arrays.asList(3, 4, 5, 6, 7, 9, 11, 12, 16, 17, 18, 20, 22, 24, 25)));
	jogos.add(new Jogo(Arrays.asList(2, 3, 4, 6, 8, 9, 10, 12, 13, 15, 16, 17, 20, 23, 25)));
	jogos.add(new Jogo(Arrays.asList(1, 2, 3, 6, 7, 8, 9, 10, 12, 15, 18, 19, 20, 23, 25)));
	jogos.add(new Jogo(Arrays.asList(4, 5, 6, 8, 9, 10, 11, 12, 14, 15, 17, 19, 20, 23, 24)));
