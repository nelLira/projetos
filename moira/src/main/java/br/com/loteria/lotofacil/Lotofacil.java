...
//		jogos.add(new Jogo(Arrays.asList(2, 3, 5, 6, 7, 8, 10, 11, 16, 17, 19, 21, 22, 24, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 5, 9, 10, 12, 14, 15, 16, 19, 20, 21, 24)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 6, 7, 9, 11, 16, 18, 19, 20, 22, 24, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 7, 9, 10, 14, 15, 16, 17, 19, 20, 23, 24, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 6, 7, 8, 9, 13, 17, 18, 19, 20, 22, 24, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 5, 6, 8, 11, 12, 14, 15, 19, 20, 21, 23, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 5, 9, 10, 12, 13, 14, 16, 19, 21, 22, 25)));
//		jogos.add(new Jogo(Arrays.asList(2, 4, 5, 6, 8, 9, 11, 12, 13, 14, 17, 19, 20, 21, 25)));
//		jogos.add(new Jogo(Arrays.asList(2, 4, 7, 8, 9, 11, 13, 14, 15, 16, 19, 20, 21, 22, 24)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 5, 6, 7, 8, 10, 11, 15, 17, 18, 19, 22, 24)));
//		jogos.add(new Jogo(Arrays.asList(2, 4, 6, 7, 9, 10, 11, 13, 14, 15, 19, 20, 21, 23, 24)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 6, 10, 12, 14, 15, 17, 18, 19, 21, 22, 23, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 8, 9, 10, 11, 14, 18, 19, 21, 22, 24, 25)));
