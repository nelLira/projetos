...
//	estisticasUltimoSorteio();
 //estatisticasUltimosSorteios(50, true);
			...
			jogos.add(new Jogo(Arrays.asList(1, 3, 4, 6, 7, 8, 11, 12, 17, 19, 21, 22, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 3, 8, 10, 11, 12, 14, 16, 17, 18, 21, 22, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 3, 4, 6, 9, 12, 13, 16, 17, 19, 21, 22, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 3, 6, 7, 8, 11, 12, 14, 16, 19, 21, 22, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 3, 5, 8, 9, 10, 11, 12, 14, 16, 18, 21, 22, 23, 24)));
			jogos.add(new Jogo(Arrays.asList(2, 3, 5, 6, 7, 8, 9, 12, 15, 16, 17, 20, 22, 24, 25)));
