...
//		jogos.add(new Jogo(Arrays.asList(2, 3, 5, 6, 7, 8, 9, 14, 16, 19, 20, 22, 23, 24, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 5, 7, 8, 9, 11, 12, 15, 16, 19, 20, 22, 23, 25)));
//		jogos.add(new Jogo(Arrays.asList(2, 4, 6, 7, 9, 11, 14, 15, 16, 18, 19, 21, 22, 24, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 6, 9, 12, 13, 14, 15, 16, 18, 22, 23, 24, 25)));
//		jogos.add(new Jogo(Arrays.asList(2, 3, 5, 7, 8, 10, 11, 12, 14, 20, 21, 22, 23, 24, 25)));
//		jogos.add(new Jogo(Arrays.asList(2, 4, 5, 6, 7, 8, 9, 11, 12, 13, 14, 16, 18, 22, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 6, 7//, 8, 9, 10, 12, 15, 19, 20, 22, 23, 24)));
//		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 7, 8, 9, 10, 13, 16, 17, 21, 22, 23, 24, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 4, 5, 7, 8, 10, 11, 12, 15, 17, 19, 20, 21, 22, 24)));
//		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 7, 8, 9, 10, 11, 14, 16, 20, 21, 22, 24, 25)));
//		jogos.add(new Jogo(Arrays.asList(2, 4, 8, 10, 11, 12, 13, 14, 15, 18, 19, 21, 22, 23, 25)));
//		jogos.add(new Jogo(Arrays.asList(2, 4, 5, 6, 8, 10, 12, 14, 15, 17, 20, 21, 22, 23, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 3, 5, 7, 8, 9, 12, 13, 14, 15, 17, 20, 21, 22, 24)));
//		jogos.add(new Jogo(Arrays.asList(3, 4, 7, 9, 10, 11, 12, 14, 15, 16, 17, 20, 21, 24, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 4, 6, 9, 10, 11, 12, 14, 15, 16, 19, 22, 23, 25)));
