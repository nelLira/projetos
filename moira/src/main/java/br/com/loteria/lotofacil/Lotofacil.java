...
public class Lotofacil {
	...
	//	estatisticasUltimosSorteios(50, true);
		...
		jogos.add(new Jogo(Arrays.asList(1, 2, 4, 6, 7, 9, 11, 13, 17, 18, 21, 22, 23, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 4, 6, 7, 9, 10, 11, 13, 15, 16, 17, 19, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 7, 9, 10, 11, 13, 14, 15, 17, 18, 21, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 4, 7, 8, 9, 10, 12, 13, 15, 17, 21, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 4, 6, 9, 10, 11, 13, 14, 15, 17, 18, 21, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 6, 9, 10, 12, 13, 16, 17, 19, 21, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 6, 7, 9, 10, 13, 15, 17, 18, 19, 21, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 4, 5, 6, 9, 11, 13, 14, 17, 18, 19, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 4, 6, 7, 9, 10, 11, 12, 13, 15, 16, 17, 18, 21, 24)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 6, 7, 9, 13, 15, 16, 18, 20, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 5, 6, 7, 9, 12, 13, 16, 17, 20, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 6, 7, 9, 13, 15, 16, 17, 21, 22, 23, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 4, 5, 6, 7, 9, 11, 17, 18, 21, 22, 23, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 6, 7, 9, 12, 13, 14, 17, 20, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 7, 9, 10, 11, 14, 17, 18, 19, 21, 22, 24)));
