...
//		estatisticasUltimosSorteios(50, true);
		...
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 6, 8, 9, 10, 12, 13, 16, 18, 19, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 4, 5, 6, 8, 10, 11, 12, 14, 16, 17, 19, 22, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 5, 8, 9, 10, 12, 14, 16, 17, 19, 20, 22, 24)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 5, 7, 8, 10, 12, 16, 19, 21, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 6, 7, 8, 10, 12, 13, 14, 17, 19, 20, 22, 23, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 4, 5, 6, 7, 8, 10, 12, 13, 14, 19, 22, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 4, 8, 10, 11, 12, 13, 14, 15, 18, 19, 20, 22, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 6, 7, 10, 12, 13, 14, 16, 18, 19, 21, 22, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 6, 8, 9, 10, 11, 12, 13, 16, 18, 19, 22, 23, 25)));
