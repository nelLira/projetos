...
// estatisticasUltimosSorteios(50, true);
			...
			jogos.add(new Jogo(Arrays.asList(1, 3, 4, 5, 8, 9, 11, 14, 15, 18, 19, 20, 21, 22, 23)));
			jogos.add(new Jogo(Arrays.asList(1, 4, 5, 7, 8, 9, 10, 13, 15, 16, 19, 21, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 3, 5, 8, 9, 11, 13, 14, 15, 16, 17, 20, 22, 23)));
			jogos.add(new Jogo(Arrays.asList(1, 3, 5, 6, 8, 9, 12, 15, 16, 17, 18, 20, 21, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 7, 8, 10, 14, 15, 19, 20, 21, 22, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 5, 10, 12, 13, 14, 15, 16, 18, 20, 21, 22, 23, 24)));
