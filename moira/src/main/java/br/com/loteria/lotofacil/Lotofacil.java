...
public class Lotofacil {
	...
	//	estatisticasUltimosSorteios(50, true);
		...
		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 6, 8, 10, 11, 12, 13, 15, 17, 18, 20, 21, 23)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 6, 8, 9, 13, 15, 17, 18, 20, 21, 22, 23, 24)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 5, 6, 7, 9, 10, 11, 12, 16, 17, 18, 19, 22, 24)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 6, 8, 10, 13, 14, 16, 18, 19, 20, 22, 23, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 6, 7, 9, 10, 11, 13, 15, 16, 17, 18, 20, 22, 24)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 5, 8, 10, 12, 13, 16, 17, 18, 19, 21, 22, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 5, 6, 7, 8, 12, 16, 17, 18, 20, 22, 23, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 7, 8, 9, 10, 12, 13, 16, 18, 20, 21, 22, 23, 24)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 4, 6, 7, 8, 12, 13, 17, 19, 20, 22, 23, 24, 25)));
