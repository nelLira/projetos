...
public class Lotofacil {
	...
	// 	estatisticasUltimosSorteios(50, true);
		...
		jogos.add(new Jogo(Arrays.asList(2, 3, 6, 7, 8, 10, 12, 15, 16, 18, 19, 20, 22, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 8, 10, 12, 15, 16, 17, 18, 19, 20, 23)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 5, 6, 9, 10, 13, 15, 16, 17, 19, 21, 23)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 5, 6, 7, 10, 11, 14, 16, 18, 19, 22, 24)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 7, 8, 9, 10, 12, 17, 20, 21, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 7, 8, 10, 13, 14, 16, 19, 20, 21, 24, 25)));
