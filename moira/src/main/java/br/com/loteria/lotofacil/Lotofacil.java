...
public class Lotofacil {
	...
	//	estatisticasUltimosSorteios(50, true);
		...
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 6, 8, 9, 10, 12, 15, 16, 19, 20, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 5, 9, 13, 14, 16, 18, 19, 20, 22, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 4, 5, 6, 8, 10, 11, 15, 17, 18, 19, 20, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 6, 9, 11, 13, 14, 15, 17, 19, 20, 21, 22, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 4, 5, 7, 9, 10, 11, 14, 16, 17, 18, 20, 23, 24, 25)));
