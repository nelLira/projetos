...
/*
		...
		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 5, 9, 11, 12, 13, 16, 17, 18, 19, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 5, 7, 8, 10, 11, 12, 13, 15, 16, 20, 22, 23, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 7, 9, 11, 12, 13, 16, 18, 19, 20, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 5, 6, 7, 10, 12, 14, 15, 17, 18, 21, 22, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 9, 10, 11, 14, 15, 17, 18, 20, 21, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 7, 8, 11, 12, 14, 15, 16, 17, 18, 21, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 7, 8, 12, 13, 14, 15, 16, 18, 19, 21, 22, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 5, 6, 7, 9, 10, 13, 15, 16, 18, 20, 21, 22, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 7, 9, 10, 13, 15, 16, 19, 20, 21, 22, 24, 25)));
