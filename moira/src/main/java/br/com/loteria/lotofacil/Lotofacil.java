...
/*
		...
		jogos.add(new Jogo(Arrays.asList(2, 5, 6, 7, 9, 10, 11, 14, 15, 17, 18, 20, 21, 22, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 5, 6, 7, 9, 10, 11, 12, 15, 17, 18, 20, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 6, 7, 8, 11, 12, 14, 17, 20, 22, 23, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 5, 6, 7, 8, 12, 14, 15, 17, 18, 20, 21, 22, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(3, 5, 6, 7, 10, 11, 12, 14, 15, 17, 20, 21, 22, 24, 25)));
