...
//estatisticasUltimosSorteios(50, true);
			...
			jogos.add(new Jogo(Arrays.asList(2, 4, 5, 10, 11, 12, 13, 15, 17, 18, 20, 21, 22, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 3, 7, 8, 9, 10, 13, 14, 15, 17, 20, 21, 22, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 5, 7, 9, 11, 12, 13, 14, 18, 20, 22, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 4, 6, 7, 8, 11, 12, 14, 15, 16, 17, 19, 20, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(3, 4, 5, 7, 9, 10, 11, 14, 15, 17, 20, 22, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 4, 6, 7, 9, 10, 11, 12, 14, 20, 21, 22, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 4, 6, 10, 12, 13, 15, 16, 17, 19, 20, 21, 22, 25)));
