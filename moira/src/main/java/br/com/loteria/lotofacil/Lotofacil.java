...
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 5, 6, 7, 10, 11, 14, 16, 18, 19, 20, 24, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 5, 6, 7, 9, 11, 16, 18, 19, 20, 21, 24, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 4, 7, 8, 9, 10, 13, 15, 16, 17, 18, 20, 21, 25)));
//		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 5, 6, 9, 10, 11, 13, 15, 18, 19, 20, 21, 24)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 5, 6, 7, 9, 12, 13, 16, 18, 19, 20, 21, 24, 25)));
//		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 6, 7, 9, 11, 13, 14, 15, 18, 19, 20, 21, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 3, 4, 5, 6, 10, 12, 13, 15, 16, 18, 19, 21, 23, 24)));	
