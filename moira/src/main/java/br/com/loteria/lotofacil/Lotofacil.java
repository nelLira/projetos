...
//		jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 7, 8, 10, 12, 15, 16, 17, 19, 21, 22)));
//		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 5, 7, 8, 9, 10, 11, 13, 18, 20, 21, 23, 25)));11
//		jogos.add(new Jogo(Arrays.asList(2, 4, 5, 6, 7, 8, 10, 11, 12, 17, 18, 19, 20, 21, 23)));11
//		jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 8, 9, 10, 12, 13, 17, 18, 20, 21, 23)));11
//		jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 7, 8, 9, 10, 11, 12, 18, 21, 23, 25)));
//		jogos.add(new Jogo(Arrays.asList(2, 3, 6, 7, 10, 12, 13, 14, 16, 17, 19, 20, 21, 22, 25)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 5, 7, 8, 9, 10, 13, 14, 15, 18, 19, 20, 22, 24)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 5, 7, 8, 9, 10, 12, 15, 17, 20, 21, 22, 24)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 5, 7, 8, 9, 10, 14, 17, 18, 20, 21, 23)));11
