...
public class Lotofacil {
	...
	List<Jogo> jogos = new ArrayList<Jogo>();
		 jogos.add(new Jogo(Arrays.asList(2, 3, 4, 7, 8, 9, 10, 11, 12, 13, 16, 19, 20, 23, 24)));
		 jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 6, 7, 8, 11, 12, 15, 16, 19, 21, 22, 23)));
		 jogos.add(new Jogo(Arrays.asList(1, 3, 4, 9, 10, 13, 15, 16, 18, 19, 20, 21, 22, 23, 24)));
		 jogos.add(new Jogo(Arrays.asList(1, 2, 3, 8, 10, 11, 12, 14, 16, 17, 18, 19, 21, 24, 25)));
		 jogos.add(new Jogo(Arrays.asList(2, 4, 6, 8, 9, 12, 13, 15, 16, 17, 21, 22, 23, 24, 25)));
		 jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 9, 11, 13, 14, 17, 18, 20, 21, 23, 24, 25)));
