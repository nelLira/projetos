...
//		gerarJogos(200,true);
	...
	//	estatisticasUltimosSorteios(50, true);
		...
		jogos.add(new Jogo(Arrays.asList(1, 3, 4, 6, 8, 11, 13, 15, 18, 19, 21, 22, 23, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 4, 6, 7, 9, 11, 12, 15, 17, 20, 21, 22, 23, 24)));
		jogos.add(new Jogo(Arrays.asList(2, 4, 6, 7, 8, 9, 11, 12, 15, 17, 18, 19, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 5, 6, 7, 8, 10, 12, 13, 14, 16, 19, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 8, 10, 11, 12, 13, 15, 17, 18, 20, 21, 23, 24)));
