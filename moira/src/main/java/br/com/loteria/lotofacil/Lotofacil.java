...
//		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 6, 7, 8, 11, 15, 16, 18, 19, 20, 21, 22, 23)));
...
//		jogos.add(new Jogo(Arrays.asList(2, 3, 4, 7, 9, 10, 11, 12, 13, 14, 16, 18, 21, 22, 25)));
...
//		jogos.add(new Jogo(Arrays.asList(1, 2, 4, 8, 9, 11, 12, 13, 14, 15, 16, 18, 22, 23, 25)));
