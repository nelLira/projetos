...
//estatisticasUltimosSorteios(50, true);
			...
			jogos.add(new Jogo(Arrays.asList(1, 3, 4, 6, 7, 9, 10, 12, 13, 14, 16, 19, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 3, 5, 6, 9, 11, 12, 14, 16, 17, 18, 19, 20, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(5, 6, 7, 9, 10, 12, 14, 15, 16, 17, 19, 21, 22, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 6, 9, 10, 11, 13, 14, 15, 16, 18, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 3, 5, 6, 7, 8, 9, 10, 13, 14, 16, 21, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 3, 4, 6, 7, 9, 10, 11, 12, 13, 14, 16, 19, 22, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 4, 5, 9, 11, 12, 14, 16, 17, 18, 21, 22, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 3, 4, 6, 7, 9, 11, 12, 13, 14, 16, 17, 18, 22, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 3, 4, 6, 9, 11, 12, 14, 16, 17, 18, 20, 22, 23, 24)));
