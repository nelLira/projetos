...
//estatisticasUltimosSorteios(50, true);
			...
			jogos.add(new Jogo(Arrays.asList(1, 3, 4, 6, 7, 9, 10, 13, 14, 15, 16, 17, 19, 20, 25)));
			jogos.add(new Jogo(Arrays.asList(3, 4, 5, 7, 8, 10, 13, 15, 16, 18, 19, 20, 22, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 4, 6, 7, 8, 9, 10, 11, 14, 16, 17, 19, 20, 24)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 7, 10, 12, 13, 14, 16, 19, 20, 21, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 3, 4, 5, 6, 8, 9, 11, 14, 16, 19, 20, 21, 22, 25)));
