...
/*		
		...
		jogos.add(new Jogo(Arrays.asList(3, 4, 5, 8, 9, 10, 11, 12, 14, 15, 17, 19, 20, 23, 24)));
		jogos.add(new Jogo(Arrays.asList(3, 5, 6, 8, 9, 11, 13, 15, 16, 17, 19, 20, 21, 22, 24)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 4, 6, 7, 9, 10, 11, 12, 13, 15, 19, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 6, 7, 10, 11, 12, 14, 15, 16, 17, 19, 21, 22, 23)));
		jogos.add(new Jogo(Arrays.asList(1, 5, 6, 8, 9, 10, 11, 12, 13, 15, 16, 19, 22, 24, 25)));
