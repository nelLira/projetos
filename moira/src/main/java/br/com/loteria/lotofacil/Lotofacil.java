...
public class Lotofacil {
	...
	//	gerarJogos(200,true);
		...
		jogos.add(new Jogo(Arrays.asList(1, 3, 6, 7, 8, 9, 12, 13, 16, 17, 19, 20, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 5, 6, 7, 8, 10, 11, 12, 13, 18, 21, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 2, 4, 7, 8, 9, 11, 12, 13, 15, 16, 17, 21, 23, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 6, 7, 8, 10, 11, 12, 14, 16, 17, 19, 22, 24, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 6, 7, 8, 10, 13, 15, 17, 18, 19, 20, 21, 22, 25)));
		jogos.add(new Jogo(Arrays.asList(1, 3, 4, 5, 7, 8, 10, 12, 13, 14, 16, 19, 21, 22, 25)));
