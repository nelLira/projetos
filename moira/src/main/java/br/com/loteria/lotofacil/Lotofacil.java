...
//		jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 9, 10, 11, 12, 14, 16, 18, 21, 22, 23)));
//		jogos.add(new Jogo(Arrays.asList(2, 3, 5, 6, 8, 10, 11, 12, 13, 16, 17, 19, 20, 22, 24)));
//		jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 6, 8, 9, 12, 14, 15, 16, 17, 20, 23, 25)));
//		jogos.add(new Jogo(Arrays.asList(2, 5, 6, 8, 10, 11, 14, 15, 17, 18, 19, 21, 22, 24, 25)));
//		jogos.add(new Jogo(Arrays.asList(3, 4, 7, 9, 10, 11, 12, 13, 14, 16, 19, 21, 22, 24, 25)));
