...
//  estatisticasUltimosSorteios(50, true);
			...
			jogos.add(new Jogo(Arrays.asList(1, 2, 3, 5, 6, 7, 8, 9, 10, 13, 15, 19, 22, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 6, 8, 9, 11, 12, 14, 15, 17, 18, 19, 20, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 5, 7, 8, 9, 11, 14, 15, 16, 18, 19, 22, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 5, 6, 7, 8, 10, 11, 13, 14, 15, 18, 21, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 3, 4, 6, 9, 11, 13, 14, 15, 18, 19, 20, 22, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 4, 7, 9, 10, 11, 12, 14, 15, 16, 18, 19, 21, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 3, 6, 8, 9, 11, 12, 13, 14, 16, 19, 21, 22, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 5, 7, 9, 10, 11, 13, 14, 15, 18, 20, 21, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 4, 5, 6, 8, 9, 10, 11, 13, 16, 18, 19, 21, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 3, 5, 6, 8, 9, 10, 11, 13, 15, 18, 20, 22, 23, 25)));
