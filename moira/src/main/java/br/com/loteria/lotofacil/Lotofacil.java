...
//	estisticasUltimoSorteio();
 //estatisticasUltimosSorteios(50, true);
			...
			jogos.add(new Jogo(Arrays.asList(2, 3, 5, 7, 8, 9, 10, 11, 14, 17, 20, 21, 22, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 5, 8, 9, 10, 11, 13, 14, 15, 17, 21, 22, 23, 24)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 3, 6, 7, 9, 10, 11, 13, 17, 19, 20, 21, 22, 24)));
			jogos.add(new Jogo(Arrays.asList(3, 5, 6, 7, 8, 9, 11, 13, 14, 15, 16, 17, 20, 22, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 5, 6, 7, 9, 11, 13, 14, 16, 17, 18, 22, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 3, 5, 9, 10, 11, 14, 16, 17, 18, 20, 22, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 3, 5, 8, 10, 11, 13, 14, 16, 17, 18, 22, 23, 24, 25)));
