...
//    estatisticasUltimosSorteios(50, true);
			...
			jogos.add(new Jogo(Arrays.asList(1, 2, 3, 5, 6, 8, 9, 12, 13, 14, 16, 19, 22, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 3, 5, 6, 10, 11, 12, 13, 14, 18, 21, 22, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 3, 4, 6, 7, 12, 13, 16, 18, 20, 21, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 3, 6, 7, 8, 9, 10, 11, 13, 14, 17, 19, 21, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(3, 4, 7, 8, 10, 12, 13, 14, 16, 17, 19, 20, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 3, 5, 10, 12, 13, 14, 15, 18, 20, 22, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(3, 5, 6, 7, 8, 12, 13, 14, 15, 17, 20, 21, 22, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 3, 5, 6, 7, 9, 12, 13, 15, 17, 18, 22, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 3, 4, 5, 6, 9, 11, 12, 13, 14, 17, 19, 20, 21, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 3, 4, 5, 6, 9, 10, 12, 14, 15, 17, 18, 19, 23, 24)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 3, 5, 6, 11, 12, 13, 15, 17, 18, 20, 21, 23, 24)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 7, 9, 10, 11, 12, 13, 14, 17, 19, 22, 23, 24, 25)));
