...
//	estisticasUltimoSorteio();
   // estatisticasUltimosSorteios(50, true);
			...
			jogos.add(new Jogo(Arrays.asList(2, 5, 6, 9, 10, 11, 13, 14, 15, 16, 18, 19, 21, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 8, 10, 11, 13, 14, 16, 18, 21, 22, 23)));
			jogos.add(new Jogo(Arrays.asList(4, 5, 7, 8, 9, 11, 13, 14, 16, 19, 20, 21, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 7, 8, 9, 11, 13, 14, 16, 21, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 9, 10, 11, 12, 13, 15, 17, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(4, 5, 6, 7, 9, 10, 11, 13, 14, 15, 18, 20, 22, 23, 24)));
			jogos.add(new Jogo(Arrays.asList(2, 5, 6, 9, 10, 11, 13, 14, 16, 17, 19, 21, 22, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 4, 6, 7, 9, 10, 11, 13, 14, 16, 17, 19, 21, 22, 23)));
			jogos.add(new Jogo(Arrays.asList(1, 3, 4, 5, 6, 7, 9, 10, 11, 14, 15, 19, 23, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 4, 6, 7, 8, 9, 11, 14, 15, 16, 19, 21, 22, 23, 24)));
			jogos.add(new Jogo(Arrays.asList(2, 5, 6, 7, 9, 10, 11, 13, 15, 16, 18, 19, 21, 23, 25)));
			jogos.add(new Jogo(Arrays.asList(2, 3, 4, 5, 6, 7, 9, 10, 11, 13, 14, 16, 18, 19, 24)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 7, 8, 10, 11, 13, 16, 17, 21, 22, 24)));
			jogos.add(new Jogo(Arrays.asList(4, 5, 7, 9, 10, 11, 12, 13, 15, 16, 19, 21, 22, 24, 25)));
			jogos.add(new Jogo(Arrays.asList(1, 2, 4, 5, 6, 7, 8, 9, 11, 13, 16, 18, 21, 22, 24)));
