...
public class FiltroCinco extends Filtro {

	private Jogo ultimoJogo;

	public FiltroCinco(Jogo jogo) {
		System.err.println("*************Filtrando a lista de números [5]**********************");
	...
	public void combinacoes() {
		Combinacao combinacoes = new Combinacao(ultimoJogo.getJogo(), 5);
